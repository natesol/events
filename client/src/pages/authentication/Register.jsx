...
import { IconAt, IconShieldCheck, IconLock, IconEyeOff, IconEye } from '@tabler/icons';
...
export function Register() {
    ...
    return (
        <>
            ...
            <Container style={{ position: 'absolute', top: '1rem', left: '0' }}>
                <BackButton to='/login' />
            </Container>
            <Section>
                    ...
                    <form onSubmit={form.onSubmit(submitForm)}>
                        <Group direction='column' grow spacing='sm'>
                            ...
                            <PasswordInput
                                ...
                                description='Password must include 1 lowercase letter, 1 uppercase letter, 1 number, and at least 6 characters'
                            ...
                            />
                            <PasswordInput
                                icon={<IconShieldCheck size='0.9em' />}
                                size='md'
